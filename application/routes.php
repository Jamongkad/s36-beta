...
return array(
	...
	*/
    ...
    'POST /submit_feedback' => function() use($company_name, $company, $hosted_settings){
        ...
        $fb_iframe = '
       <iframe src="//www.facebook.com/plugins/like.php?'.urlencode($obj->feedback_url).'&amp;send=false&amp;layout=standard&amp;width=390&amp;show_faces=false&amp;font&amp;colorscheme=light&amp;action=like&amp;height=35&amp;appId='.Config::get('application.fb_id').'" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:390px; height:35px;" allowTransparency="true"></iframe>iframe>
        ';
