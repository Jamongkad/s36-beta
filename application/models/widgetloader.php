...
class ClientRender {
    public function __construct(WidgetTypes $widget_type_obj) {
        ...
        $this->tab_position_css_output = trim(HTML::style('css/widget_master/tab-positions.css'));//trim(HTML::style(Config::get('application.deploy_env')."/widget/tab_position"));
    }  
