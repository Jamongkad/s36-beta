                	...
                	<table width="616" cellpadding="0" cellspacing="0">
                        ...
                        <tr>                        	
							<td colspan="3" style="padding-right:100px;line-height:20px;color:#464646;">
                                ...
                                <a href="<?=$email_data->host?>/password_reset?email=<?=urlencode($email_data->user_data->email)?>">
                                    <?=$email_data->host?>/password_reset?email=<?=urlencode($email_data->user_data->email)?>
                                </a>
