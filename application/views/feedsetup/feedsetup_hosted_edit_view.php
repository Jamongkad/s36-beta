...
<?=Form::hidden('background_image', $hosted_full_page->background_image)?>
<?=Form::hidden('update_background_image','false')?>
    ...
    jQuery(function($) {
        ...
        $('#hosted_background').fileupload({
          ...
          , done: function(e, data) {
                $("input[type=hidden][name=update_background_image]").val(true);
