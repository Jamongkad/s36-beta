...
{{msg.text}} 
                         ...
                         <div class="g1of3">
                             ...
                             <a href="#" style="display:none" edit-reply-settings msgid="msg.id" action="update">Update Message</a> | 
                             <a href="#" ng-click="delete_msg(msg.id, $event)">Delete Message</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-setup-block">
                    <div class="form-setup-fields grids">
                      ...
                      <div class="form-setup-elem">
                            ...
                            <a href="#" class="dashboard-button blue-invalid large" style="display:none" onClick="return false">Category names cannot exceed 45 characters</a>
