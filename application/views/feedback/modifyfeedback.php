                ...
                <div class="modify-other-info">
                    ...
                    <div class="modify-other-info-block grids">
                        ...
                        <span class="right-label">
                            <input type="checkbox" name="reset_indlock" value=1 <?=($feedback->indlock ? "checked" : Null)?> ng-click="toggle_feedback_display_lock($event)"/>
                        </span>  
                    </div>
                    <div class="modify-other-info-block grids">
                ...
                <div class="blue-bar-left">
                    <div class="grids">
                        <div class="g1of5 align-center">
                            <a href="#" class="blue-bar-reply-to-user" feedid="<?=$feedback->id?>" my-reply>CONTACT</a>
                        </div>
                        <div class="g1of5 align-center">
                        ...
                        <?if($feedback->rating != "POOR" and $feedback->int_perm == 1):?>
