<div class="lightbox-form">
    ...
    <table cellpadding="1" width="100%" class="valign-fix">
        ...
        <tr>
            ...
            <td>
                <input type="text" class="regular-text" name="subject" value="Re: regarding your feedback for {{replybody.user.companyname}}." style='width: 95%' />
            </td>
            <td></td>
        </tr>
        <tr>
                ...
                <ul class="custom-message">
                    <li ng-repeat="msg in get_reply_messages()"> 
                        ...
                        <span style="float:right">
                            <a href='#' edit-reply ng-click="edit_reply(msg.id, msg.msgtype)">edit</a> 
