function s36Lightbox(width, height, insertContent) {	
    ...
    if(insertContent != null){
        //This is just a test
        jQuery('.lightbox').append(insertContent + "<div class='lightbox-comment' style='color:#fff;position:absolute;top:10px;right:10px;z-index:100002'>This is a preview only | <span style='cursor:pointer'>close</span></div>");
    }
