...
WidgetLoader.prototype.generateFrameMarkup = function() {
    ...
    var src = '<span style="z-index:100001"><iframe id="s36Widget" allowTransparency="true" height="500" frameborder="0" scrolling="no" style="width:100%;border:none;overflow:visible;" src="'+frameUrl+'"><a href="javascript:;" title="html form">Fill out my Wufoo form!</a></iframe></span>';
    return src;
}
